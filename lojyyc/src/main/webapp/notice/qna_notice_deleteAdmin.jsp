...
<form name="deleteForm" action="/notice/noticeDeletePro.lo?notice_num=<%=notice_num%>&notice_file=<%=notice_file%>" 
	method="post">
				...
				<table style="border-collapse: inherit;">
					<tr>
						...
						<td>
							...
							<input type="password" name="DELETE_CONFIRM" id="delPW" class="insertPass">
						</td>
					</tr>
				</table>
			<div class="subtn">
...
<!-- 	</td> -->
<!-- 	<td> -->
<!-- 		<input name="DELETE_CONFIRM" type="password"> -->
<!-- 	</td> -->
<!-- </tr> -->
